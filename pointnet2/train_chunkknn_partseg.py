...
def parse_args():
    ...
    # I/O & runtime
<<<<<<< HEAD
    p.add_argument('--model', type=str, default='sngp_s2_6layers', help='model module name under models/')
    p.add_argument('--data_root', type=str, default=r'data_prepare\shapenet',
=======
...
<<<<<<< HEAD
    p.add_argument('--rff_sigmas', type=str, default='0.3,0.7,1.4', help='RFF sigma list')
=======
...
<<<<<<< HEAD
    ...
    p.add_argument('--num_part', type=int, default=5, help='number of part classes')
=======
>>>>>>> 8c1fcb01970756c50538b0deed66253798650c9b
    return p.parse_args()
...
def main():
    ...
    # ----- data -----
<<<<<<< HEAD
    root = args.data_root.replace('\\', '/')  # for Windows path compatibility
=======
    # ----- data -----
